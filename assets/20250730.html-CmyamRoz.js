...
<span class="line">    }</span>
<span class="line">};</span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,24)]))}const p=s(l,[["render",c]]),r=JSON.parse('{"path":"/leetcode/20250730.html","title":"2419. 按位与最大的最长子数组","lang":"zh-CN","frontmatter":{"date":"2025-07-30T00:00:00.000Z","category":["中等"],"tag":["位运算","数组","脑筋急转弯"]},"headers":[],"git":{"updatedTime":1753853140000,"contributors":[{"name":"zhengqianhe0","username":"zhengqianhe0","email":"1821984431@qq.com","commits":1,"url":"https://github.com/zhengqianhe0"}],"changelog":[{"hash":"40bb75f65c993fa967dcf211ffad7981eebab0c1","time":1753853140000,"email":"1821984431@qq.com","author":"zhengqianhe0","message":"每日一题"}]},"filePathRelative":"leetcode/20250730.md","excerpt":"\\n<p>中等</p>\\n<p>提示</p>\\n<p>给你一个长度为 <code>n</code> 的整数数组 <code>nums</code> 。</p>\\n<p>考虑 <code>nums</code> 中进行 **按位与（bitwise AND）**运算得到的值 <strong>最大</strong> 的 <strong>非空</strong> 子数组。</p>\\n<ul>\\n<li>换句话说，令 <code>k</code> 是 <code>nums</code> <strong>任意</strong> 子数组执行按位与运算所能得到的最大值。那么，只需要考虑那些执行一次按位与运算后等于 <code>k</code> 的子数组。</li>\\n</ul>"}');export{p as comp,r as data};
