...
<span class="line">    }</span>
<span class="line">};</span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,23)]))}const r=s(l,[["render",d]]),o=JSON.parse('{"path":"/leetcode/20250729.html","title":"2411. 按位或最大的最小子数组长度","lang":"zh-CN","frontmatter":{"date":"2025-07-29T00:00:00.000Z","category":["中等"],"tag":["位运算","数组","反向遍历"]},"headers":[],"git":{"updatedTime":1753781156000,"contributors":[{"name":"zhengqianhe0","username":"zhengqianhe0","email":"1821984431@qq.com","commits":2,"url":"https://github.com/zhengqianhe0"}],"changelog":[{"hash":"8d93e6af4f3471bd5aeea8b6f70f18329ab38856","time":1753781156000,"email":"1821984431@qq.com","author":"zhengqianhe0","message":"每日一题"},{"hash":"cf54adca54f0b2e84abffdde625d573d729db5af","time":1753710540000,"email":"1821984431@qq.com","author":"zhengqianhe0","message":"每日一题文件"}]},"filePathRelative":"leetcode/20250729.md","excerpt":"\\n<p>中等</p>\\n<p>题目描述</p>\\n<p>给你一个长度为 <code>n</code> 下标从 <strong>0</strong> 开始的数组 <code>nums</code> ，数组中所有数字均为非负整数。对于 <code>0</code> 到 <code>n - 1</code> 之间的每一个下标 <code>i</code> ，你需要找出 <code>nums</code> 中一个 <strong>最小</strong> 非空子数组，它的起始位置为 <code>i</code> （包含这个位置），同时有 <strong>最大</strong> 的 <strong>按位或运算值</strong> 。</p>"}');export{r as comp,o as data};
